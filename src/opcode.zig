pub const OPCode = enum(u32) {
    ...
    @"f64x2.splat"          = 0xFD_14,
    //
    @"i8x16.extract_lane_s" = 0xFD_15,
    @"i8x16.extract_lane_u" = 0xFD_16,
    @"i8x16.replace_lane"   = 0xFD_17,
    @"i16x8.extract_lane_s" = 0xFD_18,
    @"i16x8.extract_lane_u" = 0xFD_19,
    @"i16x8.replace_lane"   = 0xFD_1A,
    @"i32x4.extract_lane"   = 0xFD_1B,
    @"i32x4.replace_lane"   = 0xFD_1C,
    @"i64x2.extract_lane"   = 0xFD_1D,
    @"i64x2.replace_lane"   = 0xFD_1E,
    @"f32x4.extract_lane"   = 0xFD_1F,
    @"f32x4.replace_lane"   = 0xFD_20,
    @"f64x2.extract_lane"   = 0xFD_21,
    @"f64x2.replace_lane"   = 0xFD_22,
    //
    @"i8x16.eq"             = 0xFD_23,
    @"i8x16.ne"             = 0xFD_24,
    @"i8x16.lt_s"           = 0xFD_25,
    ...
    //
    @"i8x16.relaxed_swizzle"            = 0xFD_100,
    @"i32x4.relaxed_trunc_f32x4_s"      = 0xFD_101,
    @"i32x4.relaxed_trunc_f32x4_u"      = 0xFD_102,
    @"i32x4.relaxed_trunc_f64x2_s_zero" = 0xFD_103,
    @"i32x4.relaxed_trunc_f64x2_u_zero" = 0xFD_104,
    @"f32x4.qfma"                       = 0xFD_105,
    @"f32x4.qfms"                       = 0xFD_106,
    @"f64x2.qfma"                       = 0xFD_107,
    @"f64x2.qfms"                       = 0xFD_108,
    @"i8x16.relaxed_laneselect"         = 0xFD_109,
    @"i16x8.relaxed_laneselect"         = 0xFD_10A,
    @"i32x4.relaxed_laneselect"         = 0xFD_10B,
    @"i64x2.relaxed_laneselect"         = 0xFD_10C,
    @"f32x4.relaxed_min"                = 0xFD_10D,
    @"f32x4.relaxed_max"                = 0xFD_10E,
    @"f64x2.relaxed_min"                = 0xFD_10F,
    @"f64x2.relaxed_max"                = 0xFD_110,
    @"i16x8.relaxed_q15mulr_s"          = 0xFD_111,
    @"i16x8.dot_i8x16_i7x16_s"          = 0xFD_112,
    @"i32x4.dot_i8x16_i7x16_add_s"      = 0xFD_113,
    //
    @"memory.atomic.notify"             = 0xFE_00,
    @"memory.atomic.wait32"             = 0xFE_01,
    @"memory.atomic.wait64"             = 0xFE_02,
    @"atomic.fence"                     = 0xFE_03,
    @"i32.atomic.load"                  = 0xFE_10,
    @"i64.atomic.load"                  = 0xFE_11,
    @"i32.atomic.load8_u"               = 0xFE_12,
    @"i32.atomic.load16_u"              = 0xFE_13,
    @"i64.atomic.load8_u"               = 0xFE_14,
    @"i64.atomic.load16_u"              = 0xFE_15,
    @"i64.atomic.load32_u"              = 0xFE_16,
    @"i32.atomic.store"                 = 0xFE_17,
    @"i64.atomic.store"                 = 0xFE_18,
    @"i32.atomic.store8"                = 0xFE_19,
    @"i32.atomic.store16"               = 0xFE_1A,
    @"i64.atomic.store8"                = 0xFE_1B,
    @"i64.atomic.store16"               = 0xFE_1C,
    @"i64.atomic.store32"               = 0xFE_1D,
    @"i32.atomic.rmw.add"               = 0xFE_1E,
    @"i64.atomic.rmw.add"               = 0xFE_1F,
    @"i32.atomic.rmw8.add_u"            = 0xFE_20,
    @"i32.atomic.rmw16.add_u"           = 0xFE_21,
    @"i64.atomic.rmw8.add_u"            = 0xFE_22,
    @"i64.atomic.rmw16.add_u"           = 0xFE_23,
    @"i64.atomic.rmw32.add_u"           = 0xFE_24,
    @"i32.atomic.rmw.sub"               = 0xFE_25,
    @"i64.atomic.rmw.sub"               = 0xFE_26,
    @"i32.atomic.rmw8.sub_u"            = 0xFE_27,
    @"i32.atomic.rmw16.sub_u"           = 0xFE_28,
    @"i64.atomic.rmw8.sub_u"            = 0xFE_29,
    @"i64.atomic.rmw16.sub_u"           = 0xFE_2A,
    @"i64.atomic.rmw32.sub_u"           = 0xFE_2B,
    @"i32.atomic.rmw.and"               = 0xFE_2C,
    @"i64.atomic.rmw.and"               = 0xFE_2D,
    @"i32.atomic.rmw8.and_u"            = 0xFE_2E,
    @"i32.atomic.rmw16.and_u"           = 0xFE_2F,
    @"i64.atomic.rmw8.and_u"            = 0xFE_30,
    @"i64.atomic.rmw16.and_u"           = 0xFE_31,
    @"i64.atomic.rmw32.and_u"           = 0xFE_32,
    @"i32.atomic.rmw.or"                = 0xFE_33,
    @"i64.atomic.rmw.or"                = 0xFE_34,
    @"i32.atomic.rmw8.or_u"             = 0xFE_35,
    @"i32.atomic.rmw16.or_u"            = 0xFE_36,
    @"i64.atomic.rmw8.or_u"             = 0xFE_37,
    @"i64.atomic.rmw16.or_u"            = 0xFE_38,
    @"i64.atomic.rmw32.or_u"            = 0xFE_39,
    @"i32.atomic.rmw.xor"               = 0xFE_3A,
    @"i64.atomic.rmw.xor"               = 0xFE_3B,
    @"i32.atomic.rmw8.xor_u"            = 0xFE_3C,
    @"i32.atomic.rmw16.xor_u"           = 0xFE_3D,
    @"i64.atomic.rmw8.xor_u"            = 0xFE_3E,
    @"i64.atomic.rmw16.xor_u"           = 0xFE_3F,
    @"i64.atomic.rmw32.xor_u"           = 0xFE_40,
    @"i32.atomic.rmw.xchg"              = 0xFE_41,
    @"i64.atomic.rmw.xchg"              = 0xFE_42,
    @"i32.atomic.rmw8.xchg_u"           = 0xFE_43,
    @"i32.atomic.rmw16.xchg_u"          = 0xFE_44,
    @"i64.atomic.rmw8.xchg_u"           = 0xFE_45,
    @"i64.atomic.rmw16.xchg_u"          = 0xFE_46,
    @"i64.atomic.rmw32.xchg_u"          = 0xFE_47,
    @"i32.atomic.rmw.cmpxchg"           = 0xFE_48,
    @"i64.atomic.rmw.cmpxchg"           = 0xFE_49,
    @"i32.atomic.rmw8.cmpxchg_u"        = 0xFE_4A,
    @"i32.atomic.rmw16.cmpxchg_u"       = 0xFE_4B,
    @"i64.atomic.rmw8.cmpxchg_u"        = 0xFE_4C,
    @"i64.atomic.rmw16.cmpxchg_u"       = 0xFE_4D,
    @"i64.atomic.rmw32.cmpxchg_u"       = 0xFE_4E,
    // zig fmt: on
};
