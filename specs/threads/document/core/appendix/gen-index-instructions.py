...
INSTRUCTIONS = [
    ...
    Instruction(r'\I32.\ATOMICSTORE\K{8\_u}~\memarg', r'\hex{FE}~\hex{19}', r'[\I32~\I32] \to []', r'valid-atomic.storen', r'exec-atomic.storen'),
    Instruction(r'\I32.\ATOMICSTORE\K{16\_u}~\memarg', r'\hex{FE}~\hex{1A}', r'[\I32~\I32] \to []', r'valid-atomic.storen', r'exec-atomic.storen'),
    Instruction(r'\I64.\ATOMICSTORE\K{8\_u}~\memarg', r'\hex{FE}~\hex{1B}', r'[\I32~\I64] \to []', r'valid-atomic.storen', r'exec-atomic.storen'),
    Instruction(r'\I64.\ATOMICSTORE\K{16\_u}~\memarg', r'\hex{FE}~\hex{1C}', r'[\I32~\I64] \to []', r'valid-atomic.storen', r'exec-atomic.storen'),
    Instruction(r'\I64.\ATOMICSTORE\K{32\_u}~\memarg', r'\hex{FE}~\hex{1D}', r'[\I32~\I64] \to []', r'valid-atomic.storen', r'exec-atomic.storen'),
    Instruction(r'\I32.\ATOMICRMW.\ATADD~\memarg', r'\hex{FE}~\hex{1E}', r'[\I32~\I32] \to [\I32]', r'valid-atomic.rmw', r'exec-atomic.rmw', r'op-iadd'),
    Instruction(r'\I64.\ATOMICRMW.\ATADD~\memarg', r'\hex{FE}~\hex{1F}', r'[\I32~\I64] \to [\I64]', r'valid-atomic.rmw', r'exec-atomic.rmw', r'op-iadd'),
    Instruction(r'\I32.\ATOMICRMW\K{8}.\ATADD\K{\_u}~\memarg', r'\hex{FE}~\hex{20}', r'[\I32~\I32] \to [\I32]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-iadd'),
    Instruction(r'\I32.\ATOMICRMW\K{16}.\ATADD\K{\_u}~\memarg', r'\hex{FE}~\hex{21}', r'[\I32~\I32] \to [\I32]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-iadd'),
    Instruction(r'\I64.\ATOMICRMW\K{8}.\ATADD\K{\_u}~\memarg', r'\hex{FE}~\hex{22}', r'[\I32~\I64] \to [\I64]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-iadd'),
    Instruction(r'\I64.\ATOMICRMW\K{16}.\ATADD\K{\_u}~\memarg', r'\hex{FE}~\hex{23}', r'[\I32~\I64] \to [\I64]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-iadd'),
    Instruction(r'\I64.\ATOMICRMW\K{32}.\ATADD\K{\_u}~\memarg', r'\hex{FE}~\hex{24}', r'[\I32~\I64] \to [\I64]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-iadd'),
    Instruction(r'\I32.\ATOMICRMW.\ATSUB~\memarg', r'\hex{FE}~\hex{25}', r'[\I32~\I32] \to [\I32]', r'valid-atomic.rmw', r'exec-atomic.rmw', r'op-isub'),
    Instruction(r'\I64.\ATOMICRMW.\ATSUB~\memarg', r'\hex{FE}~\hex{26}', r'[\I32~\I64] \to [\I64]', r'valid-atomic.rmw', r'exec-atomic.rmw', r'op-isub'),
    Instruction(r'\I32.\ATOMICRMW\K{8}.\ATSUB\K{\_u}~\memarg', r'\hex{FE}~\hex{27}', r'[\I32~\I32] \to [\I32]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-isub'),
    Instruction(r'\I32.\ATOMICRMW\K{16}.\ATSUB\K{\_u}~\memarg', r'\hex{FE}~\hex{28}', r'[\I32~\I32] \to [\I32]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-isub'),
    Instruction(r'\I64.\ATOMICRMW\K{8}.\ATSUB\K{\_u}~\memarg', r'\hex{FE}~\hex{29}', r'[\I32~\I64] \to [\I64]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-isub'),
    Instruction(r'\I64.\ATOMICRMW\K{16}.\ATSUB\K{\_u}~\memarg', r'\hex{FE}~\hex{2A}', r'[\I32~\I64] \to [\I64]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-isub'),
    Instruction(r'\I64.\ATOMICRMW\K{32}.\ATSUB\K{\_u}~\memarg', r'\hex{FE}~\hex{2B}', r'[\I32~\I64] \to [\I64]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-isub'),
    Instruction(r'\I32.\ATOMICRMW.\ATAND~\memarg', r'\hex{FE}~\hex{2C}', r'[\I32~\I32] \to [\I32]', r'valid-atomic.rmw', r'exec-atomic.rmw', r'op-iand'),
    Instruction(r'\I64.\ATOMICRMW.\ATAND~\memarg', r'\hex{FE}~\hex{2D}', r'[\I32~\I64] \to [\I64]', r'valid-atomic.rmw', r'exec-atomic.rmw', r'op-iand'),
    Instruction(r'\I32.\ATOMICRMW\K{8}.\ATAND\K{\_u}~\memarg', r'\hex{FE}~\hex{2E}', r'[\I32~\I32] \to [\I32]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-iand'),
    Instruction(r'\I32.\ATOMICRMW\K{16}.\ATAND\K{\_u}~\memarg', r'\hex{FE}~\hex{2F}', r'[\I32~\I32] \to [\I32]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-iand'),
    Instruction(r'\I64.\ATOMICRMW\K{8}.\ATAND\K{\_u}~\memarg', r'\hex{FE}~\hex{30}', r'[\I32~\I64] \to [\I64]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-iand'),
    Instruction(r'\I64.\ATOMICRMW\K{16}.\ATAND\K{\_u}~\memarg', r'\hex{FE}~\hex{31}', r'[\I32~\I64] \to [\I64]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-iand'),
    Instruction(r'\I64.\ATOMICRMW\K{32}.\ATAND\K{\_u}~\memarg', r'\hex{FE}~\hex{32}', r'[\I32~\I64] \to [\I64]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-iand'),
    Instruction(r'\I32.\ATOMICRMW.\ATOR~\memarg', r'\hex{FE}~\hex{33}', r'[\I32~\I32] \to [\I32]', r'valid-atomic.rmw', r'exec-atomic.rmw', r'op-ior'),
    Instruction(r'\I64.\ATOMICRMW.\ATOR~\memarg', r'\hex{FE}~\hex{34}', r'[\I32~\I64] \to [\I64]', r'valid-atomic.rmw', r'exec-atomic.rmw', r'op-ior'),
    Instruction(r'\I32.\ATOMICRMW\K{8}.\ATOR\K{\_u}~\memarg', r'\hex{FE}~\hex{35}', r'[\I32~\I32] \to [\I32]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-ior'),
    Instruction(r'\I32.\ATOMICRMW\K{16}.\ATOR\K{\_u}~\memarg', r'\hex{FE}~\hex{36}', r'[\I32~\I32] \to [\I32]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-ior'),
    Instruction(r'\I64.\ATOMICRMW\K{8}.\ATOR\K{\_u}~\memarg', r'\hex{FE}~\hex{37}', r'[\I32~\I64] \to [\I64]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-ior'),
    Instruction(r'\I64.\ATOMICRMW\K{16}.\ATOR\K{\_u}~\memarg', r'\hex{FE}~\hex{38}', r'[\I32~\I64] \to [\I64]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-ior'),
    Instruction(r'\I64.\ATOMICRMW\K{32}.\ATOR\K{\_u}~\memarg', r'\hex{FE}~\hex{39}', r'[\I32~\I64] \to [\I64]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-ior'),
    Instruction(r'\I32.\ATOMICRMW.\ATXOR~\memarg', r'\hex{FE}~\hex{3A}', r'[\I32~\I32] \to [\I32]', r'valid-atomic.rmw', r'exec-atomic.rmw', r'op-ixor'),
    Instruction(r'\I64.\ATOMICRMW.\ATXOR~\memarg', r'\hex{FE}~\hex{3B}', r'[\I32~\I64] \to [\I64]', r'valid-atomic.rmw', r'exec-atomic.rmw', r'op-ixor'),
    Instruction(r'\I32.\ATOMICRMW\K{8}.\ATXOR\K{\_u}~\memarg', r'\hex{FE}~\hex{3C}', r'[\I32~\I32] \to [\I32]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-ixor'),
    Instruction(r'\I32.\ATOMICRMW\K{16}.\ATXOR\K{\_u}~\memarg', r'\hex{FE}~\hex{3D}', r'[\I32~\I32] \to [\I32]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-ixor'),
    Instruction(r'\I64.\ATOMICRMW\K{8}.\ATXOR\K{\_u}~\memarg', r'\hex{FE}~\hex{3E}', r'[\I32~\I64] \to [\I64]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-ixor'),
    Instruction(r'\I64.\ATOMICRMW\K{16}.\ATXOR\K{\_u}~\memarg', r'\hex{FE}~\hex{3F}', r'[\I32~\I64] \to [\I64]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-ixor'),
    Instruction(r'\I64.\ATOMICRMW\K{32}.\ATXOR\K{\_u}~\memarg', r'\hex{FE}~\hex{40}', r'[\I32~\I64] \to [\I64]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-ixor'),
    Instruction(r'\I32.\ATOMICRMW.\ATXCHG~\memarg', r'\hex{FE}~\hex{41}', r'[\I32~\I32] \to [\I32]', r'valid-atomic.rmw', r'exec-atomic.rmw', r'op-ixchg'),
    Instruction(r'\I64.\ATOMICRMW.\ATXCHG~\memarg', r'\hex{FE}~\hex{42}', r'[\I32~\I64] \to [\I64]', r'valid-atomic.rmw', r'exec-atomic.rmw', r'op-ixchg'),
    Instruction(r'\I32.\ATOMICRMW\K{8}.\ATXCHG\K{\_u}~\memarg', r'\hex{FE}~\hex{43}', r'[\I32~\I32] \to [\I32]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-ixchg'),
    Instruction(r'\I32.\ATOMICRMW\K{16}.\ATXCHG\K{\_u}~\memarg', r'\hex{FE}~\hex{44}', r'[\I32~\I32] \to [\I32]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-ixchg'),
    Instruction(r'\I64.\ATOMICRMW\K{8}.\ATXCHG\K{\_u}~\memarg', r'\hex{FE}~\hex{45}', r'[\I32~\I64] \to [\I64]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-ixchg'),
    Instruction(r'\I64.\ATOMICRMW\K{16}.\ATXCHG\K{\_u}~\memarg', r'\hex{FE}~\hex{46}', r'[\I32~\I64] \to [\I64]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-ixchg'),
    Instruction(r'\I64.\ATOMICRMW\K{32}.\ATXCHG\K{\_u}~\memarg', r'\hex{FE}~\hex{47}', r'[\I32~\I64] \to [\I64]', r'valid-atomic.rmwn', r'exec-atomic.rmwn', r'op-ixchg'),
